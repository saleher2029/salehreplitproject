...
export default function AdminSettings() {
  ...
  const handleSave = () => {
    updateMut.mutate({ data: { whatsappNumber, subscriptionInfo } }, {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-muted-foreground mt-1">تحكم في نصوص الموقع ورقم التواصل</p>
      </div>
      ...
      <Card className="p-6 md:p-8 rounded-3xl border-border shadow-sm">
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            />
            <p className="text-xs text-muted-foreground">اكتب الرقم مع رمز الدولة وبدون مسافات، سيتم استخدامه في رابط التواصل أعلى الموقع.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Input 
              ...
              placeholder="مثال: اشترك الآن عبر بنك فلسطين..."
            />
          </div>
