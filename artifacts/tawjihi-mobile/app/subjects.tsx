...
export default function SubjectsScreen() {
  ...
  const COLORS = ["#1E40AF", "#7C3AED", "#059669", "#D97706", "#DC2626", "#0891B2", "#4F46E5", "#DB2777"];
    ...
    <View style={[styles.container, { backgroundColor: C.background }]}>
      <View style={[styles.header, { paddingTop: insets.top + 12, backgroundColor: C.card, borderBottomColor: C.border }]}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={[styles.headerSub, { color: C.textSecondary, fontFamily: "Tajawal_400Regular" }]}>اختر المادة</Text>
        </View>
      </View>
      ...
      {!isLoading && !error && (!subjects || subjects.length === 0) && (
        <View style={styles.center}>
          ...
          <Text style={[styles.emptyText, { color: C.textSecondary, fontFamily: "Tajawal_400Regular" }]}>لا توجد مواد في هذا التخصص</Text>
        </View>
      )}
